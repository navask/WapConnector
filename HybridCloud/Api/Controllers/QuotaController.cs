...
namespace Microsoft.WindowsAzurePack.ResourceProvider.HybridCloud.Api.Controllers
{
    ...
    {
        /// <summary>
        /// Gets the default quota for Hybrid Cloud Resource Provider.
        /// </summary>
        [HttpGet]
        ...
        public QuotaUpdateResultBatch UpdateQuota(QuotaUpdateBatch quotaUpdateBatch)
        {
            ...
            // For this sample sake we are just returning QuotaUpdateResultBatch since no quota value is exposed from Hybrid Cloud RP
