...
namespace Microsoft.WindowsAzurePack.ResourceProvider
{
    /// <summary>
    ...
    public class AdminManagementClient : ManagementClientBase, IAdminManagementClient
    {
        ...
        public Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> CreateResourceProviderAsync(Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider)
        {
            return this.SendAsync<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider, Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider>(
        ...
        public Task<ResourceProviderVerificationResult> VerifyResourceProviderAsync(
            Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider, 
        ...
        /// <param name="resourceProvider">resource provider</param>
        public Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> UpdateResourceProviderAsync(string name, string instanceId, Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider)
        {
            return this.SendAsync<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider, Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider>(
        ...
        /// <param name="name">resource provider name</param>
        /// <param name="instanceId">resource provider instance id</param>
        public Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> GetResourceProviderAsync(string name, string instanceId)
        {
            ...
            return this.GetAsync<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider>(requestUri);
        }
