...
namespace Microsoft.WindowsAzurePack.ResourceProvider
{
    ...
    public interface IAdminManagementClient
    {
        ...
        Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> CreateResourceProviderAsync(Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider);
        ...
        Task<ResourceProviderVerificationResult> VerifyResourceProviderAsync(Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider, ResourceProviderVerificationTestList verificationTests);
        ...
        /// <param name="resourceProvider">resource provider</param>
        Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> UpdateResourceProviderAsync(string name, string instanceId, Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider resourceProvider);
        ...
        /// <param name="name">resource provider name</param>
        /// <param name="instanceId">resource provider instance id</param>
        Task<Microsoft.WindowsAzurePack.ResourceProvider.DataContracts.ResourceProvider> GetResourceProviderAsync(string name, string instanceId);
